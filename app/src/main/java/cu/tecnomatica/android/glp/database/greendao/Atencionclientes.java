...
{
    @Id
    private Long idatencionclientes;
    ...
    @Generated(hash = 1237322749)
    private transient AtencionclientesDao myDao;

    @Generated(hash = 1917863882)
    public Atencionclientes(Long idatencionclientes, Long idprovincia,
            String nombre, String direccion, String telefono, String horario,
            String latitud, String longitud) {
        this.idatencionclientes = idatencionclientes;
    ...
    @Generated(hash = 1134119541)
    public Atencionclientes() {
    }

    public Long getIdatencionclientes() {
        return this.idatencionclientes;
    }

    public void setIdatencionclientes(Long idatencionclientes) {
        this.idatencionclientes = idatencionclientes;
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 751306108)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getAtencionclientesDao() : null;
    }
}